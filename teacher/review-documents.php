 ...
 * FIXED: Uses teacher_modules for access (assigned modules)
 */
...
// Get modules assigned OR created by teacher
if ($role === 'admin') {
...
// Get topics/learning outcomes (for LO selection in upload form)
$topics = [];
if ($selectedModuleId > 0) {
    $stmt = $pdo->prepare("
        SELECT DISTINCT lo.outcome_id, lo.outcome_number
                ...
                <div class="form-group">
                    ...
                    <select name="topic_id" class="form-control">
                        ...
                        <?php foreach($topics as $topic): ?>
                            <option value="<?php echo $topic['outcome_id']; ?>">LO<?php echo $topic['outcome_number']; ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div class="form-group">
